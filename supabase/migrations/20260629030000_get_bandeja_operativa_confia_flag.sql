-- P02: get_bandeja_operativa confía en pago_completado (autoritativo vía trigger).
-- Fecha: 2026-06-29
--
-- Único cambio vs versión previa: parcialidades_vencidas ya NO recalcula saldo_residual;
-- confía en pago_completado (ahora autoritativo). El resto (mantenimiento via cuenta padre,
-- invalidos en RPC, montos de display) se mantiene. Firma sin cambios -> CREATE OR REPLACE.
-- Idempotente. Verificado en dev: función existe; columnas referenciadas existen.
